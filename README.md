...
|-------------|-----------------------|------------------|---------------|--------------|-------|
| 2 3 4 Player Games | 3.8.0 | 12 | ✅ || Touchscreen is recommended for the Team vs. Team maches
| 23andMe | 5.114.0 | 11 | ✅ |
| 4PDA | 1.9.35 | 11 | ✅ |
...
| Kahoot || 11 | ✅
| Katakana Pro | 1.4.4 | 12 | ✅ | Scaling issue when the app is in landscape mode.
...
| Shazam | 12.33.0-220714 | 12 | ✅ | Shazam on pop-up doesn't work | Requires microphone
